<x-admin_layout>
    ...
    <section class="grid grid-cols-3 grid-rows-1 w-full gap-6 mb-6">
        <div class="p-2 border shadow rounded">
            ...
            <img src="" alt="" class="w-full h-[200px] rounded-full object-center object-cover mb-2">
    ...
    <section class="grid grid-rows-1 grid-cols-3 gap-2">
        ...
        <div class="p-2 shadow border rounded min-h-[400px]">
            ...
            <div class="rounded border shadow min-h-[350px]">
